...
__all__ = ["ClusterIssuerPatchArgs", "ClusterIssuerPatch"]


@pulumi.input_type
class ClusterIssuerPatchArgs:
    def __init__(
        __self__,
        *,
        ...
        spec: Optional[pulumi.Input["ClusterIssuerSpecPatchArgs"]] = None
    ):
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input["ClusterIssuerSpecPatchArgs"]]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: Optional[pulumi.Input["ClusterIssuerSpecPatchArgs"]]):
        pulumi.set(self, "spec", value)


class ClusterIssuerPatch(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        spec: Optional[
            pulumi.Input[
                Union["ClusterIssuerSpecPatchArgs", "ClusterIssuerSpecPatchArgsDict"]
            ]
        ] = None,
        __props__=None,
    ):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ClusterIssuerPatchArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        ...
        :param str resource_name: The name of the resource.
        :param ClusterIssuerPatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ClusterIssuerPatchArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ClusterIssuerPatchArgs.__new__(ClusterIssuerPatchArgs)
        ...
        super(ClusterIssuerPatch, __self__).__init__(
    ...
    def get(
        ...
        __props__.__dict__["status"] = None
        return ClusterIssuerPatch(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional["outputs.ClusterIssuerSpecPatch"]]:
        return pulumi.get(self, "spec")

    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional["outputs.ClusterIssuerStatusPatch"]]:
