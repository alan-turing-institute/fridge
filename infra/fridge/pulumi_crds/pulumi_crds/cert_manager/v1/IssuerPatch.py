...
__all__ = ["IssuerPatchArgs", "IssuerPatch"]


@pulumi.input_type
class IssuerPatchArgs:
    def __init__(
        __self__,
        *,
        ...
        spec: Optional[pulumi.Input["IssuerSpecPatchArgs"]] = None
    ):
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input["IssuerSpecPatchArgs"]]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: Optional[pulumi.Input["IssuerSpecPatchArgs"]]):
        pulumi.set(self, "spec", value)


class IssuerPatch(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        spec: Optional[
            pulumi.Input[Union["IssuerSpecPatchArgs", "IssuerSpecPatchArgsDict"]]
        ] = None,
        __props__=None,
    ):
        """
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[IssuerPatchArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        ...
        :param str resource_name: The name of the resource.
        :param IssuerPatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            IssuerPatchArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = IssuerPatchArgs.__new__(IssuerPatchArgs)
        ...
        super(IssuerPatch, __self__).__init__(
            "kubernetes:cert-manager.io/v1:IssuerPatch", resource_name, __props__, opts
        )
    ...
    def get(
        ...
        __props__.__dict__["status"] = None
        return IssuerPatch(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional["outputs.IssuerSpecPatch"]]:
        return pulumi.get(self, "spec")

    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional["outputs.IssuerStatusPatch"]]:
