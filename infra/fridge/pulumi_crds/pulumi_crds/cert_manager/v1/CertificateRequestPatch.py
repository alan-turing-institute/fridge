...
__all__ = ["CertificateRequestPatchArgs", "CertificateRequestPatch"]


@pulumi.input_type
class CertificateRequestPatchArgs:
    def __init__(
        __self__,
        *,
        ...
        spec: Optional[pulumi.Input["CertificateRequestSpecPatchArgs"]] = None
    ):
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input["CertificateRequestSpecPatchArgs"]]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: Optional[pulumi.Input["CertificateRequestSpecPatchArgs"]]):
        pulumi.set(self, "spec", value)


class CertificateRequestPatch(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[CertificateRequestPatchArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        ...
        :param str resource_name: The name of the resource.
        :param CertificateRequestPatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CertificateRequestPatchArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = CertificateRequestPatchArgs.__new__(CertificateRequestPatchArgs)
        ...
        super(CertificateRequestPatch, __self__).__init__(
    ...
    def get(
        ...
        __props__.__dict__["status"] = None
        return CertificateRequestPatch(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional["outputs.CertificateRequestSpecPatch"]]:
        return pulumi.get(self, "spec")
    ...
    def status(
        self,
    ) -> pulumi.Output[Optional["outputs.CertificateRequestStatusPatch"]]:
