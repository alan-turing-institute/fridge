...
__all__ = ["ClusterIssuerInitArgs", "ClusterIssuer"]


@pulumi.input_type
class ClusterIssuerInitArgs:
    def __init__(
        __self__,
        *,
...
class ClusterIssuer(pulumi.CustomResource):
    ...
    def __init__(
        ...
        spec: Optional[
            pulumi.Input[Union["ClusterIssuerSpecArgs", "ClusterIssuerSpecArgsDict"]]
        ] = None,
        __props__=None,
    ):
        """
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ClusterIssuerInitArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        A ClusterIssuer represents a certificate issuing authority which can be
        ...
        :param str resource_name: The name of the resource.
        :param ClusterIssuerInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ClusterIssuerInitArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ClusterIssuerInitArgs.__new__(ClusterIssuerInitArgs)
