...
__all__ = ["CertificateRequestInitArgs", "CertificateRequest"]


@pulumi.input_type
class CertificateRequestInitArgs:
    def __init__(
        __self__,
        *,
...
class CertificateRequest(pulumi.CustomResource):
    ...
    def __init__(
        ...
        spec: Optional[
            pulumi.Input[
                Union["CertificateRequestSpecArgs", "CertificateRequestSpecArgsDict"]
            ]
        ] = None,
        __props__=None,
    ):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[CertificateRequestInitArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        A CertificateRequest is used to request a signed certificate from one of the
        ...
        :param str resource_name: The name of the resource.
        :param CertificateRequestInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CertificateRequestInitArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = CertificateRequestInitArgs.__new__(CertificateRequestInitArgs)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output["outputs.CertificateRequestSpec"]:
        return pulumi.get(self, "spec")
