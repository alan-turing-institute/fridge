...
__all__ = ["CertificateRequestListArgs", "CertificateRequestList"]


@pulumi.input_type
class CertificateRequestListArgs:
    def __init__(
        __self__,
        *,
        items: pulumi.Input[Sequence[pulumi.Input["CertificateRequestArgs"]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CertificateRequestArgs']]] items: List of certificaterequests. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", "CertificateRequestList")
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input["CertificateRequestArgs"]]]:
        """
    ...
    @items.setter
    def items(
        self, value: pulumi.Input[Sequence[pulumi.Input["CertificateRequestArgs"]]]
    ):
...
class CertificateRequestList(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        items: Optional[
            pulumi.Input[
                Sequence[
                    pulumi.Input[
                        Union["CertificateRequestArgs", "CertificateRequestArgsDict"]
                    ]
                ]
            ]
        ] = None,
        ...
        :param pulumi.Input[str] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['CertificateRequestArgs', 'CertificateRequestArgsDict']]]] items: List of certificaterequests. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        :param pulumi.Input[str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: CertificateRequestListArgs,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        CertificateRequestList is a list of CertificateRequest
        ...
        :param str resource_name: The name of the resource.
        :param CertificateRequestListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CertificateRequestListArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = CertificateRequestListArgs.__new__(CertificateRequestListArgs)

            __props__.__dict__["api_version"] = "cert-manager.io/v1"
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = "CertificateRequestList"
            __props__.__dict__["metadata"] = metadata
        super(CertificateRequestList, __self__).__init__(
    ...
    def get(
        ...
        return CertificateRequestList(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence["outputs.CertificateRequest"]]:
        """
        List of certificaterequests. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        """
        return pulumi.get(self, "items")
