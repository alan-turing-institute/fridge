...
__all__ = ["IssuerListArgs", "IssuerList"]


@pulumi.input_type
class IssuerListArgs:
    def __init__(
        __self__,
        *,
        items: pulumi.Input[Sequence[pulumi.Input["IssuerArgs"]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IssuerArgs']]] items: List of issuers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", "IssuerList")
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input["IssuerArgs"]]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input["IssuerArgs"]]]):
...
class IssuerList(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        api_version: Optional[pulumi.Input[str]] = None,
        items: Optional[
            pulumi.Input[Sequence[pulumi.Input[Union["IssuerArgs", "IssuerArgsDict"]]]]
        ] = None,
        kind: Optional[pulumi.Input[str]] = None,
        metadata: Optional[
        ...
        :param pulumi.Input[str] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['IssuerArgs', 'IssuerArgsDict']]]] items: List of issuers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        :param pulumi.Input[str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def __init__(
        ...
        :param str resource_name: The name of the resource.
        :param IssuerListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            IssuerListArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = IssuerListArgs.__new__(IssuerListArgs)

            __props__.__dict__["api_version"] = "cert-manager.io/v1"
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = "IssuerList"
            __props__.__dict__["metadata"] = metadata
        super(IssuerList, __self__).__init__(
            "kubernetes:cert-manager.io/v1:IssuerList", resource_name, __props__, opts
        )
    ...
    def get(
        ...
        return IssuerList(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence["outputs.Issuer"]]:
        """
        List of issuers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        """
        return pulumi.get(self, "items")
