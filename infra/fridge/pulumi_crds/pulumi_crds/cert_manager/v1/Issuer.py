...
__all__ = ["IssuerInitArgs", "Issuer"]


@pulumi.input_type
class IssuerInitArgs:
    def __init__(
        __self__,
        *,
...
class Issuer(pulumi.CustomResource):
    ...
    def __init__(
        ...
        spec: Optional[
            pulumi.Input[Union["IssuerSpecArgs", "IssuerSpecArgsDict"]]
        ] = None,
        __props__=None,
    ):
        """
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[IssuerInitArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        An Issuer represents a certificate issuing authority which can be
        ...
        :param str resource_name: The name of the resource.
        :param IssuerInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            IssuerInitArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = IssuerInitArgs.__new__(IssuerInitArgs)
        ...
        super(Issuer, __self__).__init__(
            "kubernetes:cert-manager.io/v1:Issuer", resource_name, __props__, opts
        )
