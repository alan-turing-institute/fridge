...
class ListMeta(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ListMeta. Access the value via the '{suggest}' property getter instead."
            )
...
class ManagedFieldsEntry(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ManagedFieldsEntry. Access the value via the '{suggest}' property getter instead."
            )
...
class ManagedFieldsEntryPatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ManagedFieldsEntryPatch. Access the value via the '{suggest}' property getter instead."
            )
...
class ObjectMeta(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ObjectMeta. Access the value via the '{suggest}' property getter instead."
            )
...
class ObjectMetaPatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ObjectMetaPatch. Access the value via the '{suggest}' property getter instead."
            )
...
class OwnerReference(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in OwnerReference. Access the value via the '{suggest}' property getter instead."
            )
...
class OwnerReferencePatch(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in OwnerReferencePatch. Access the value via the '{suggest}' property getter instead."
            )
