...
if not MYPY:
    ...
    class ObjectMetaPatchArgsDict(TypedDict):
        ...
        managed_fields: NotRequired[
            pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryPatchArgsDict"]]]
        ]
        """
        ...
        """
        owner_references: NotRequired[
            pulumi.Input[Sequence[pulumi.Input["OwnerReferencePatchArgsDict"]]]
        ]
        """
...
class ObjectMetaPatchArgs:
    def __init__(
        ...
        *,
        ...
        managed_fields: Optional[
            pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryPatchArgs"]]]
        ] = None,
        name: Optional[pulumi.Input[str]] = None,
        namespace: Optional[pulumi.Input[str]] = None,
        owner_references: Optional[
            pulumi.Input[Sequence[pulumi.Input["OwnerReferencePatchArgs"]]]
        ] = None,
        resource_version: Optional[pulumi.Input[str]] = None,
        self_link: Optional[pulumi.Input[str]] = None,
    ...
    def managed_fields(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryPatchArgs"]]]]:
        """
        ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like "ci-cd". The set of fields is always in the version that the workflow used when modifying the object.
        """
    ...
    def owner_references(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input["OwnerReferencePatchArgs"]]]]:
        """
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller.
        """
...
if not MYPY:
    ...
    class ObjectMetaArgsDict(TypedDict):
        ...
        """
        managed_fields: NotRequired[
            pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryArgsDict"]]]
        ]
        """
        ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like "ci-cd". The set of fields is always in the version that the workflow used when modifying the object.
        """
        ...
        """
        owner_references: NotRequired[
            pulumi.Input[Sequence[pulumi.Input["OwnerReferenceArgsDict"]]]
        ]
        """
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller.
        """
...
class ObjectMetaArgs:
    def __init__(
        ...
        *,
        ...
        labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
        managed_fields: Optional[
            pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryArgs"]]]
        ] = None,
        name: Optional[pulumi.Input[str]] = None,
        namespace: Optional[pulumi.Input[str]] = None,
        owner_references: Optional[
            pulumi.Input[Sequence[pulumi.Input["OwnerReferenceArgs"]]]
        ] = None,
        resource_version: Optional[pulumi.Input[str]] = None,
        self_link: Optional[pulumi.Input[str]] = None,
        uid: Optional[pulumi.Input[str]] = None
    ...
    def managed_fields(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryArgs"]]]]:
        """
        ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like "ci-cd". The set of fields is always in the version that the workflow used when modifying the object.
        """
        return pulumi.get(self, "managed_fields")
    ...
    def managed_fields(
        self,
        value: Optional[pulumi.Input[Sequence[pulumi.Input["ManagedFieldsEntryArgs"]]]],
    ):
        pulumi.set(self, "managed_fields", value)
    ...
    def owner_references(
        self,
    ) -> Optional[pulumi.Input[Sequence[pulumi.Input["OwnerReferenceArgs"]]]]:
        """
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller.
        """
        return pulumi.get(self, "owner_references")
    ...
    def owner_references(
        self,
        value: Optional[pulumi.Input[Sequence[pulumi.Input["OwnerReferenceArgs"]]]],
    ):
        pulumi.set(self, "owner_references", value)
