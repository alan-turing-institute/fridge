...
__all__ = ["ChallengePatchArgs", "ChallengePatch"]


@pulumi.input_type
class ChallengePatchArgs:
    def __init__(
        __self__,
        *,
        ...
        spec: Optional[pulumi.Input["ChallengeSpecPatchArgs"]] = None
    ):
        """
    ...
    @property
    @pulumi.getter
    def spec(self) -> Optional[pulumi.Input["ChallengeSpecPatchArgs"]]:
        return pulumi.get(self, "spec")

    @spec.setter
    def spec(self, value: Optional[pulumi.Input["ChallengeSpecPatchArgs"]]):
        pulumi.set(self, "spec", value)


class ChallengePatch(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        spec: Optional[
            pulumi.Input[Union["ChallengeSpecPatchArgs", "ChallengeSpecPatchArgsDict"]]
        ] = None,
        __props__=None,
    ):
        """
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ChallengePatchArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        ...
        :param str resource_name: The name of the resource.
        :param ChallengePatchArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ChallengePatchArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ChallengePatchArgs.__new__(ChallengePatchArgs)
        ...
        super(ChallengePatch, __self__).__init__(
            "kubernetes:acme.cert-manager.io/v1:ChallengePatch",
            resource_name,
            __props__,
            opts,
        )
    ...
    def get(
        ...
        __props__.__dict__["status"] = None
        return ChallengePatch(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional["outputs.ChallengeSpecPatch"]]:
        return pulumi.get(self, "spec")

    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional["outputs.ChallengeStatusPatch"]]:
