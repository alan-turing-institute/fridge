...
__all__ = ["ChallengeInitArgs", "Challenge"]


@pulumi.input_type
class ChallengeInitArgs:
    def __init__(
        __self__,
        *,
...
class Challenge(pulumi.CustomResource):
    ...
    def __init__(
        ...
        spec: Optional[
            pulumi.Input[Union["ChallengeSpecArgs", "ChallengeSpecArgsDict"]]
        ] = None,
        __props__=None,
    ):
        """
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[ChallengeInitArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        Challenge is a type to represent a Challenge request with an ACME server
        ...
        :param str resource_name: The name of the resource.
        :param ChallengeInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ChallengeInitArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ChallengeInitArgs.__new__(ChallengeInitArgs)
