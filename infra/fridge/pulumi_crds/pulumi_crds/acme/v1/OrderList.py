...
__all__ = ["OrderListArgs", "OrderList"]
...
class OrderListArgs:
    def __init__(
        __self__,
        *,
        items: pulumi.Input[Sequence[pulumi.Input["OrderArgs"]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OrderArgs']]] items: List of orders. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", "OrderList")
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input["OrderArgs"]]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input["OrderArgs"]]]):
...
class OrderList(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        api_version: Optional[pulumi.Input[str]] = None,
        items: Optional[
            pulumi.Input[Sequence[pulumi.Input[Union["OrderArgs", "OrderArgsDict"]]]]
        ] = None,
        kind: Optional[pulumi.Input[str]] = None,
        metadata: Optional[
        ...
        :param pulumi.Input[str] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['OrderArgs', 'OrderArgsDict']]]] items: List of orders. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        :param pulumi.Input[str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def __init__(
        ...
        :param str resource_name: The name of the resource.
        :param OrderListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            OrderListArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = OrderListArgs.__new__(OrderListArgs)

            __props__.__dict__["api_version"] = "acme.cert-manager.io/v1"
            if items is None and not opts.urn:
                raise TypeError("Missing required property 'items'")
            __props__.__dict__["items"] = items
            __props__.__dict__["kind"] = "OrderList"
            __props__.__dict__["metadata"] = metadata
        super(OrderList, __self__).__init__(
            "kubernetes:acme.cert-manager.io/v1:OrderList",
            resource_name,
            __props__,
            opts,
        )
    ...
    def get(
        ...
        return OrderList(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence["outputs.Order"]]:
        """
        List of orders. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        """
        return pulumi.get(self, "items")
