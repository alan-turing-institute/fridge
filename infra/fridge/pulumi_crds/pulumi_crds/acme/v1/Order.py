...
class Order(pulumi.CustomResource):
    ...
    def __init__(
        ...
        spec: Optional[
            pulumi.Input[Union["OrderSpecArgs", "OrderSpecArgsDict"]]
        ] = None,
        __props__=None,
    ):
        """
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: Optional[OrderInitArgs] = None,
        opts: Optional[pulumi.ResourceOptions] = None,
    ):
        """
        Order is a type to represent an Order with an ACME server
        ...
        :param str resource_name: The name of the resource.
        :param OrderInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            OrderInitArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = OrderInitArgs.__new__(OrderInitArgs)
        ...
        super(Order, __self__).__init__(
            "kubernetes:acme.cert-manager.io/v1:Order", resource_name, __props__, opts
        )
